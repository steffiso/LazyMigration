...
/** Token Manager. */
public class ParserIDBQueryToJavaTokenManager implements ParserIDBQueryToJavaConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 0:
                  ...
                  else if ((0x3000000200000000L & l) != 0L)
                  {
                     if (kind > 10)
                        kind = 10;
                  }
...
null, "\156\157\164", null, null, "\72\55", "\56", "\54", "\50", "\51", };
